...
dotnet build "C:\git\BDTest\BDTest\BDTest.csproj" /p:AssemblyVersion=%version%
dotnet build "C:\git\BDTest\BDTest\BDTest.csproj" --configuration Release /p:AssemblyVersion=%version%
...
dotnet build "C:\git\BDTest\BDTest.NUnit\BDTest.NUnit.csproj" /p:AssemblyVersion=%version%
dotnet build "C:\git\BDTest\BDTest.NUnit\BDTest.NUnit.csproj" --configuration Release /p:AssemblyVersion=%version%
...
dotnet build "C:\git\BDTest\BDTest.ReportGenerator\BDTest.ReportGenerator.csproj" /p:AssemblyVersion=%version%
dotnet build "C:\git\BDTest\BDTest.ReportGenerator\BDTest.ReportGenerator.csproj" --configuration Release /p:AssemblyVersion=%version%
